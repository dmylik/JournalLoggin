    ...
    <div id="prib1">
        ...
        <div id="nav">
            <form id="Data" style=" margin-bottom: 0px;" accept-charset="UTF-8">
                ...
                <!-- Кнопка активации -->
                <button style="width: 150px;" form="Data" type="submit"><%=data%></button>
                        ...
                        <div class="modal-wrap" aria-hidden="true" role="dialog">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input style="width: 230px; height: 25px;" type="text" name="name"
                                           />
<%--                                    <button style="width: 80px; height: 35px;" type="submit">Принять</button>--%>
                                ...
                                <div class="modal-body">
                                    ...
                                    <input style="width: 230px; height: 25px;" type="text" name="tema"
                                          />
<%--                                    <button style="width: 80px;  height: 35px;" type="submit">Принять</button>--%>
                                    <%--                              --%>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <input style="width: 230px; height: 25px;" type="text" name="email"/>
                                </div>
                                <button style="width: 200px; height: 35px; margin-left: 30px" type="submit">Принять</button>
                            </div>
                        </div>
                    </div>
            ...
            <%
                ...
                if (!tb_2.filterSpis().equals("")) {
            %>
                <b style="font-size: 20px; margin-left: 25px;"><%=tb_2.filterSpis()%></b>
            <%}%>
        ...
        <table class="timecard" width="98%">
            ...
            <c:forEach var="n" begin="0" items="${que1.rows}">
                ...
                <c:choose>
                    <c:when test="${Filtr}">
                        <tr>
                            <td style="text-align: center;"><c:out escapeXml="false" value="${n.view_dat_create}"/>&nbsp;</td>
                            ...
                            <td style="text-align: center;">
                                <form method="post" action="dwlFile" style="margin-bottom: 0px;">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <button type="submit" name="btn" value="dwnFile" id="dwnFile" ><%=fileName%></button>
